...
### Conclusion
The accuracy for Random Forest algorithm is 99.7% while Classification Tree only yields ~69%.Based on the result, the random forest algorithm is chosen as it has much better performance.
